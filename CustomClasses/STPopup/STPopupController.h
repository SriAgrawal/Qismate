...
@protocol STPopUpProtocol <NSObject>
@optional
-(void)dismissPopUp;
-(void)didFailDismissPopup;
-(void)onMovingPopup;

@end
@interface STPopupController : NSObject

@property (nonatomic,strong)  UIImageView *arrowDownImage;
/**
...
@property(strong, nonatomic) id<STPopUpProtocol> delegate;
/**
