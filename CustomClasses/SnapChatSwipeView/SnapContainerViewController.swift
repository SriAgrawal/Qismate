...
class SnapContainerViewController: UIViewController, UIScrollViewDelegate {
    ...
    func setupHorizontalScrollView() {
        ...
        let scrollHeight  = kWindowHeight()
...
//            // moved right
//            if scrollView.contentOffset.x > 1 && scrollView.contentOffset.x < kWindowWidth() {
//                if isFirst {
//                    isFirst = false
...
//                }
//            }
//        } else if (lastScrollX > scrollView.contentOffset.x) {
//            // moved left
//            if scrollView.contentOffset.x < 2*kWindowWidth() && scrollView.contentOffset.x > kWindowWidth() {
//                if isFirst {
//                    isFirst = false
//                    let notificationName = Notification.Name("CameraWillAppear")
//                    NotificationCenter.default.post(name: notificationName, object: nil)
...
//            NotificationCenter.default.post(name: notificationName, object: nil)
//        }else 
        if scrollView.contentOffset.x == 2*kWindowWidth(){
//            isFirst = true
