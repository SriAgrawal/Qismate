...
- (void)viewDidLoad {
   ...
   // _menuView.scrollView.contentInset = UIEdgeInsetsMake(0, 15, 0, 0);
...
- (void)scrollMenuViewSelectedIndex:(NSInteger)index
{
    ...
    // item color
    NSLog(@"fgdfgdf----%@", self.menuItemTitleColor);
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    // item color
    [_menuView setItemTextColor:self.menuItemTitleColor seletedItemTextColor:self.menuItemSelectedTitleColor currentIndex:currentIndex];
