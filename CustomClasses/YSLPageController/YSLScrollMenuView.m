...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _itemTitleColor = [UIColor colorWithWhite:1.0 alpha:0.3];
        _itemSelectedTitleColor = [UIColor whiteColor];
       // _itemIndicatorColor = [UIColor colorWithRed:0.168627 green:0.498039 blue:0.839216 alpha:1.0];
        _itemIndicatorColor = [UIColor clearColor];
            ...
            currentIndex:(NSInteger)currentIndex
{
    ...
    for (int i = 0; i < self.itemViewArray.count; i++) {
        ...
        if (i == currentIndex) {
            label.alpha = 0.0;
            [UIView animateWithDuration:0.0  //0.75
                                  delay:0.0
