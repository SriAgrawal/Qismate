...
extension NSDictionary {
    ...
    func objectForKeyNotNull(_ key:String, expected:AnyObject?) -> AnyObject {
...
//    func objectForKeyNotNullExpectedObj(_ key:String, expectedObj:AnyObject) -> AnyObject {
//        
//        let object = self.object(forKey: key)
//        
//        if object is NSNull {
...
//        return newImage!
        ...
        let resizedSize = CGSize(width: Int(targetSize.width), height: Int(targetSize.height))
